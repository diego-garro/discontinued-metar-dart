class Temperature implements Comparable<Temperature> {
  ...
  static double _kelvin_to_celsius(double value) =>
      value < 0 ? -_kelvin : value - _kelvin;

  ///celsius to rankine
  static double _celsius_to_rankine(double value) =>
      value * 9 / 5 + 32 + 459.67;
  ...
  ///rankine to celsius
  static double _rankine_to_celsius(double value) =>
      value < 0 ? -_kelvin : (value - 459.67 - 32) * 5 / 9;

  ///romer to celsius
  static double _romer_to_celsius(double value) => (value - 7.5) * 40 / 21;

  Temperature.fromCelsius({double value = 0.0}) : _temperature = value;
  Temperature.fromFahrenheit({double value = 0.0})
      : _temperature = _fahrenheit_to_celsius(value);
  Temperature.fromKelvin({double value = 0.0})
      : _temperature = _kelvin_to_celsius(value);
  Temperature.fromRankine({double value = 0.0})
      : _temperature = _rankine_to_celsius(value);
  Temperature.fromRomer({double value = 0.0})
      : _temperature = _romer_to_celsius(value);
