...
void main() async {
  ...
  var metarcode =
      'NFNM 122100Z 13025G35KT 7000 3000NW R07L/M0050D 270V100 +RA BR VCTS FEW010 SCT025TCU BKN100 28/27 A3002 RERA BECMG 25005KT 4SM';
  // var metarcode =
  ...
  print('Trend Wind Direction: ${metar.trendWindDir.directionInDegrees}');
  print('Trend Wind Speed: ${metar.trendWindSpeed.inKnot}');
  print('Trend visibility: ${metar.trendVisibility.inKilometers}');
}
